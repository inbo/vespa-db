        ...
        <div class="row h-100 align-items-center justify-content-center">
            ...
            <div class="card shadow">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" id="username" class="form-control" v-model="username" placeholder="Gebruikersnaam">
                </div>
                <div class="form-group mb-3">
                    <label for="password" class="form-label">Wachtwoord</label>
                    <input type="password" id="password" class="form-control" v-model="password" placeholder="Wachtwoord">
                </div>
